                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    ...
                                    <h1 class="h3 font-w700 mt-30 mb-10">Register Here Farmer</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Please Enter Your Details</h2>
                                </div>
                                <!-- END Header -->
                                ...
                                <form class="js-validation-signin px-30" id="loginForm" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="text" class="form-control" id="login-fullname" name="fullname">
                                                <label for="login-fullname">Fullname</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-hero btn-alt-primary">
                                            <i class="si si-signup mr-10"></i> Register
                                        </button>
                                        <div class="mt-30">
